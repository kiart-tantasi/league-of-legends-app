...
public class UserFilter extends OncePerRequestFilter {
  ...
  private Map<String, String> initCookiesMap(HttpServletRequest request) {
    ...
    return Arrays.stream(cookies)
        .collect(Collectors.toMap(c -> formatCookieName(c.getName()), Cookie::getValue));
  }
  ...
  private Cookie createCookie(String cookieName, String cookieValue, boolean isHttpOnly,
                              boolean isSecure, int expireMonth) {
